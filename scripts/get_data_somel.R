...
## Read CEL files
cel_cbc_files = list.files("/Users/ulas/Projects/msc_thesis/data/raw/GSE22569", full.names=TRUE, pattern="CEL")
cel_pfc_files = list.files("/Users/ulas/Projects/msc_thesis/data/raw/GSE18069", full.names=TRUE, pattern="CEL")
