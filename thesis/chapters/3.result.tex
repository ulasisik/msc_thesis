...
To compare heterogeneity change occuring before and after adulthood, each dataset were first seperated into two datasets: development dataset 
...
The fact that development datasets are clustered more closely compared to aging datasets may reflect an increase in heterogeneity during agig period.
...
Whilst the difference in correlation of heterogeneity change between development and aging datasets were not significant (permutation test p-value=0.2),
...
Moreover, comparison of median heterogeneity changes between development and aging datasets revealed that 
18 of 19 datasets showed more increase during aging compared to development. 
The permutation test further demonstrated that overall increase in heterogeneity during aging compared to development is significant (permutation test p-value < 0.001).

Although I observed increased heterogeneity during aging compared to development, 
one possible explanation may be related to positive correlation between mean and variation, 
...
Spearman's correlation test revealed that there is no significance dependence between expression and heterogeneity change.
...
and this increase is not a technical artifact (\textbf{Figure~\ref{fig:fig3.3}b}), I next focus on detecting those genes showing consistent change in heterogeneity. 
For each gene, I calculated number of datasets in which they show consistent increase in heterogeneity (in development and aging periods separately), 
...
during aging period, whereas no such shift was observed in development datasets.
...
whereas there was only 1 gene showing consistent decrease in all datasets during aging period.
