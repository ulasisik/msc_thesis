...
This step is required to combine and analyze data from different platforms, since we need to have expression values that are defined universally (i.e., on gene IDs).
...
For the dataset generated by HuGene-1\char`_0-st (Somel2011 datasets), Ensembl v.84 annotations~\cite{Yates2016} were retrieved through `biomaRt' library in R~\cite{Durinck2009}.
...
Lastly, for the Colantuoni2011 dataset, the Entrez gene IDs were retrieved from GEO database.
